...
## <a id="Navigation">📖 快速导航</a>

  - **[已收录数据集简介](#data-included)**：快速了解各数据集背景及适用场景。
  - **[打包数据下载](#download-summary)**：直接获取处理好的二进制数据包。
...
#### 1\. Shenzhen Automatic Weather Station Data (城市尺度)
  ...
  - **来源**：[深圳政府数据开放平台](https://opendata.sz.gov.cn/)
  - **Process Code**: [查看数据下载处理示例](./sz_weather/readme.md)
...
#### 2\. ERA5-CN (国家尺度)
  ...
  - **Process Code**: [查看数据下载处理示例](./era5/readme.md)
...
- **数据描述**：[查看 yaml 文件](./fluid_dynamics/naca.yaml)
...
#### 5\. METR-LA / PEMS-BAY
  ...
  - **download**: [Google Drive - Common Spatio-Temporal-Sequence Datasets](https://drive.google.com/file/d/1BKZ8Iqfo2x610sUxGEMCjpFYyn_UllTK/view?usp=sharing)
  - **Process Code**: [查看数据处理示例](./time_series/readme.md)
...
#### 8\. ETT (Electricity Transformer Temperature)
  ...
  - **Source Git link**: [https://github.com/zhouhaoyi/ETDataset](https://github.com/zhouhaoyi/ETDataset)
  - **Download**: [Common Time-Series Datasets](https://drive.google.com/file/d/1qo-EWkPz-13IjYly9J_4B9In-aXuB--y/view?usp=sharing)
  - **Process Code**: [查看数据处理示例](./time_series/readme.md)
...
## <a id="download-summary"></a> ⬇️ 数据下载汇总
